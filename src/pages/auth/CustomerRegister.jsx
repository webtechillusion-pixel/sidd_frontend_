...
const Register = () => {
  ...
  return (
    <AuthLayout
      ...
      subtitle="Join Pariyatan to start planning your journey across India"
    ...
    >
      ...
      >
        <motion.div
          ...
          className="mb-4"
        >
          <Link to="/" className="text-sm text-gray-600 hover:text-blue-600 flex items-center gap-1 transition-colors">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-3">
            ...
            <label className="flex items-start">
              ...
              />
              <span className="ml-2 text-sm text-gray-600">
                Send me travel tips, promotions, and updates about journeys
              </span>
            </label>
          </div>
