...
import { HelpCircle, Phone, MessageSquare, AlertTriangle, Clock, CheckCircle, Car, Shield, MapPin, CreditCard } from 'lucide-react';

const RiderSupport = ({ onClose }) => {
  const [selectedIssue, setSelectedIssue] = useState('');
  const [message, setMessage] = useState('');
  const [tickets, setTickets] = useState([
    {
      id: 1,
      issue: 'Customer not at pickup',
      status: 'resolved',
      time: '1 hour ago',
      response: 'Customer contacted and ride completed successfully.'
    }
  ]);

  const issueTypes = [
    { id: 'customer_late', label: 'Customer is late', icon: Clock },
    { id: 'customer_not_found', label: 'Cannot find customer', icon: AlertTriangle },
    { id: 'wrong_pickup', label: 'Wrong pickup address', icon: MapPin },
    { id: 'payment_issue', label: 'Payment problem', icon: CreditCard },
    { id: 'vehicle_breakdown', label: 'Vehicle breakdown', icon: Car },
        ...
        <div className="p-4">
          ...
          <div className="mb-6 p-4 bg-red-50 border border-red-200 rounded-lg">
            ...
            <p className="text-sm text-red-600 mb-3">
              For immediate assistance, safety concerns, or vehicle breakdown
            </p>
            <button
          ...
          <div className="mb-6">
            ...
            <div className="grid grid-cols-2 gap-2">
              <button
                onClick={() => window.location.href = 'tel:+911800654321'}
              ...
              >
                ...
                <span className="text-sm">Rider Support</span>
              </button>
              <button
          ...
          <div className="mb-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
            <h4 className="font-semibold text-blue-800 mb-2">Rider Resources</h4>
